...
//!
//! Parses and constructs the 4 Nostr event kinds used by v1 TollGate:
//! - Kind 10021: TollGate Discovery (advertisement)
//! - Kind 1022: Session
//! - Kind 21000: Payment
//! - Kind 21023: Notice
//!
...
impl TollGateAdvertisement {
    ...
    ///
    /// Each tag: `["price_per_step", "cashu", "<price>", "<unit>", "<mint_url>", "<min_steps>"]`
